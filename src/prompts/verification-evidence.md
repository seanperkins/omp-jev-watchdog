...
Select the offered untruncated actual tool-result ID ONLY when it directly contradicts the untruncated final claim of successful verification, a completed outcome, or satisfaction of a concrete requested condition. Both IDs MUST exist and be untruncated. Otherwise select `__none__`.
